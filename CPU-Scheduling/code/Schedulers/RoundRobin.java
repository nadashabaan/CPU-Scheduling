...
class RoundRobin{
    ...
    public static void FindAvg(ArrayList<Process> processes, int quantum){
        ...
        System.out.println("Average Turn Around Time : "+totalTA+"\ttime unit");
